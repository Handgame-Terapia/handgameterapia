...
const Footer = () => {
    ...
    return (
        <>
            <footer className="bg-bgc-nav text-neutral-300 p-4 text-lg">
                <div className="flex flex-col md:flex-row justify-between items-center px-6 w-full h-full gap-4">
                    {userId ? (
                    ...
                    <div className="flex flex-col gap-1 items-end md:w-1/3">
